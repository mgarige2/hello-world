...
<html lang="en-US">
<head>
<title>How To Create an Example Website</title>
<meta charset="utf-8">
...
<h1>How TO - Example Website</h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="howto_css_style_header.asp">&#10094; Previous</a>
<a class="w3-right w3-btn" href="howto_css_two_columns.asp">Next &#10095;</a>
</div>
<hr>
<p class="intro">Learn how to create a responsive website that will work on all devices:
PC, laptop, tablet, and phone.
</p>
<hr>
<h2>Example Website</h2>
<p>We have created a free responsive example website with HTML and CSS. Try to rezise the browser window to see the responsive effect:</p>
<div class="w3-content" style="max-width:1200px">
<iframe src="tryhow_css_example_website.htm" class="w3-round" style="width:100%;border:6px solid #e9e9e9;height:600px"></iframe>
<div class="w3-row-padding" style="margin:16px -16px 0 -16px">
  <div class="w3-col m6">
    <a href="tryhow_css_example_website.htm" target="_blank" class="w3-btn w3-padding-large w3-dark-grey w3-block">Demo</a>
  </div>
  <div class="w3-col m6">
    <a href="tryit.asp?filename=tryhow_css_example_website" target="_blank" class="w3-btn w3-padding-large w3-green w3-block">Try it Yourself</a>
  </div>
</div>
</div>
